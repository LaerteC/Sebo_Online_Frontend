...
import { LivroPublicadoComponent } from './livroPublicado.component';
...
describe('PostComponent', () => {
  let component: LivroPublicadoComponent;
  let fixture: ComponentFixture<LivroPublicadoComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [ LivroPublicadoComponent, MockVoteButtonComponent, MockPosteDeleteButtonComponent ],
      providers:[
    ...
    fixture = TestBed.createComponent(LivroPublicadoComponent);
